...
export default function Login() {
    ...
    const loginBtn = async (e) => {
        ...
        await axios
            .post('http://3.38.103.20:8000/auth/login', { userID: ID, passwd: PW })
            .then((userData) => {
    ...
    if (cookies.id) {
        useEffect(() => {
            const fetchEvents = async () => {
                const res = await axios.get(`http://3.38.103.20:8000/users/${cookies.id}`);
    ...
    const authCheck = () => {
        ...
        axios
            .post('http://3.38.103.20:8000/auth/verify')
            .then((res) => {
